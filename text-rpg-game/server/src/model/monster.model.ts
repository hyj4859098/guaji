...
export class MonsterModel implements IBaseModel<Monster> {
  ...
  async list(ctx?: any): Promise<Monster[]> {
  ...
  async listByLevel(minLevel: number, maxLevel: number, ctx?: any): Promise<Monster[]> {
  ...
  async listByMapId(mapId: number, ctx?: any): Promise<Monster[]> {
