...
router.post('/use', auth, validate(bagUseBody), asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.post('/clear-equipment', auth, asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.post('/delete', auth, validate(bagDeleteBody), asyncHandler(async (req: AuthRequest, res: Response) => {
  const { id } = req.body;
...
router.post('/wear', auth, validate(bagWearBody), asyncHandler(async (req: AuthRequest, res: Response) => {
  const { id } = req.body;
