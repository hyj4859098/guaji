...
router.post('/learn', auth, validate(skillLearnBody), asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.post('/equip', auth, validate(skillEquipBody), asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.post('/unequip', auth, validate(skillUnequipBody), asyncHandler(async (req: AuthRequest, res: Response) => {
  const { skill_id } = req.body;
...
router.get('/equipped', auth, asyncHandler(async (req: AuthRequest, res: Response) => {
